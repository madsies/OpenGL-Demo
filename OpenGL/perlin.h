...
/*
    Multiple Runs of perlin noise to create more interesting shapes.

    Persistence - How much it changes, lower = more default
...
float perlinNoiseFractal(float x, float y, float z = 0.0f, int octaves = 12, float persistence = 0.4f)
{
    ...
    return total / maxValue; // Normalised
}